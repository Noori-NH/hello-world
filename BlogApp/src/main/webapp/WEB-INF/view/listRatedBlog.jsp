...
<div ng-repeat="c in rbgls | filter:na">
   ...
   <a href="displayTagBlog?s={{c.btag}}">{{c.btag}}</a></p>
    ...
    <div class="row">
	    ...
	    <font color="blue">{{c.bwebsite}}</font></p>
	 </div>    
	   
	   <div class="row">
		<p><font size="3" face="georgia">Comment:</font>
	    <font color="blue">{{c.bcomment}}</font></p>
	 </div>  
  ...
  <ul class="nav navbar-nav">
    <li><a type="button" href="editBlog?id={{c.blogid}}" class="btn btn-info btn-md">Edit</a></li>
    <li><a type="button" href="deleteBlog?id={{c.blogid}}" class="btn btn-info btn-md">Delete</a></li>
    <li><a href="mail" class="btn btn-info btn-md">Email</a></li>
    </ul>

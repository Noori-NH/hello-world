...
<script src="http://ajax.googleapis.com/ajax/libs/angularjs/1.2.23/angular.min.js"></script>
 ...
 angular.module('myApp3',[]).controller('customersCtrl3', function($scope)
    	{
...
<div class="container">
<div class="row">
<div class="container" ng-app="myApp3" ng-controller="customersCtrl3">
...
<div ng-repeat="c in pstfrmls | filter:na">
         		<p><font color="red" size="5" face="georgia">{{c.fusername}}</font>  <font size="3">{{c.fcreate_date}}</p>

...
<script src="http://ajax.googleapis.com/ajax/libs/angularjs/1.2.23/angular.min.js"></script>
 <!-- <script src="resources/app.js" type="text/javascript"></script> -->
    ...
    <script>
 var v=${cfdata};
 angular.module('myApp1',[]).controller('customersCtrl1', function($scope)
    	{
...
<div class="container">
<div class="row">
<div class="container" ng-app="myApp1" ng-controller="customersCtrl1">
...
<div ng-repeat="c in cfrmls | filter:na">

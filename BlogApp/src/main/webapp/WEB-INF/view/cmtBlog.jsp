...
<ul class="nav navbar-nav">
  ...
  <form:input path="blogid" cssClass="form-control" value="" readonly="true" placeholder="Blog id....."/>
  </div>
   <!--  <div class="col-sm-3">
  ...
  <form:input path="btitle" cssClass="form-control" value="${cmtbgInfo.btitle}" readonly="true" placeholder="Blog post title....."/>
      ...
      <form:input cssClass="form-control" value="${cmtbgInfo.bcontent}" readonly="true" placeholder="Post your blog content....." rows="10" path="bcontent" />
      </div>
     <!--   <div class="col-sm-3">
      ...
      <div class="form-group">
			<div class="col-xs-5">
				<label for="btag">Tags:</label>
					<form:input path="btag" value="${cmtbgInfo.btag}" readonly="true" placeholder="Tag your blog...." cssClass="form-control"/>
						</div>
						 <!--  <div class="col-sm-3">
      ...
      <div class="form-group">
			<div class="col-xs-5">
				<!--  <label for="brate">Rate blog:</label>-->
					<form:input path="brate" value="0" readonly="true" cssClass="form-control"/>
						</div>
						<!--   <div class="col-sm-5">

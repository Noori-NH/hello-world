 ...
 <!-- <div id="navbar-main"> -->
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse" id="navbar-collapse">
          <ul class="nav navbar-nav">
			...
			<li> <a href="tooltip" class="smoothScroll"> Tooltip</a></li>
			<li> <a href="displayBlog" class="smoothScroll"> DisplayBlog</a></li>
			<li> <a href="listStudent" class="smoothScroll"> Student info</a></li>
			<li> <a href="listBlog" class="smoothScroll">ListBlogs</a></li>
      ...
      <ul class="dropdown-menu">
        <li><a href="viewProfile" class="smoothScroll">view profile</a></li>

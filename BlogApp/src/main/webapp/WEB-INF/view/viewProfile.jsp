 ...
 <form:form id="userProfileForm" class="form-horizontal" method="post" action="./profileSave" enctype="multipart/form-data"> 
     ...
     <div class="row">
				 ...
				 <label class="col-sm-2 control-label">Name:</label>
						...
						<input type="text" id="txtid" name="t1" cssClass="form-control"/>
					</div>
				</div>
			</div>
			...
			<div class="form-group">
					<div class="col-sm-2">
						<input type="submit" name="view" value="view" class="btn btn-success pull-center"/>
...
<div class="col-sm-7 pull-right">
 <div class="span5">
         <div class="spanAddress">
			<address>
			    <strong>Id:</strong> <span>${student.sid}</span><br>
      ...
      <form:form id="userProfileForm" class="form-horizontal" method="post" action="./addPhoto" enctype="multipart/form-data"> 
      <div class="row">
    <!--  <div class="col-sm-2">
   ...
   <img src="${pageContext.request.contextPath}<c:out value="${m}"/>"  class="img-rounded" alt="instrument2" height="160px" width="160px">
      ...
      <div class="form-group">
				...
				<input type="submit" name="submit" value="add photo" class="btn btn-success">
			</div>

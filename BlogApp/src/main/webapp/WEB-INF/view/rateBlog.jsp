...
<ul class="nav navbar-nav">
  ...
  <form:input path="blogid" cssClass="form-control" value="${rtbgInfo.blogid}" readonly="true" placeholder="Blog id....."/>
  </div>
   <!--  <div class="col-sm-3">
  ...
  <form:input path="btitle" cssClass="form-control" value="${rtbgInfo.btitle}" readonly="true" placeholder="Blog post title....."/>
      ...
      <form:input cssClass="form-control" value="${rtbgInfo.bcontent}" readonly="true" placeholder="Post your blog content....." rows="10" path="bcontent" />
      </div>
      <!--  <div class="col-sm-3">
      ...
      <div class="form-group">
			<div class="col-xs-5">
				<label for="btag">Tags:</label>
					<form:input path="btag" value="${rtbgInfo.btag}" readonly="true" placeholder="Tag your blog...." cssClass="form-control"/>
						</div>
						 <!-- <div class="col-sm-3">
      ...
      <div class="form-group">
			<div class="col-xs-5">
				<label for="bcreate_date">Publish on:</label>
					<form:input path="bcreate_date" value="${rtbgInfo.bcreate_date}" readonly="true" placeholder="dd/mm/yyyy hh:mi" cssClass="form-control"/>
						</div>
						 <!--  <div class="col-sm-5">
      ...
      <div class="form-group">
			<div class="col-xs-5">
				  <label for="bwebsite">Website:</label>
					<form:input path="bwebsite" value="${rtbgInfo.bwebsite}" readonly="true" placeholder="Reference link......" cssClass="form-control"/>
						</div>
						 <!--  <div class="col-sm-5">
      ...
      <div class="form-group">
			<div class="col-xs-5">
				<label for="bcomment">Comment:</label>
					<form:input path="bcomment" value="${rtbgInfo.bcomment}" readonly="true"  placeholder="Comment....." cssClass="form-control"/>
						</div>
						  <!-- <div class="col-sm-5">

...
<ul class="nav navbar-nav">
 ...
 <!-- <label for="fusername">Username:</label>-->
  <form:hidden path="fusername" cssClass="form-control" value="${cmtfrmInfo.fusername}" placeholder="Username....."/>
  </div>
   <div class="col-sm-3">
						<form:errors path="fusername"  cssStyle="color:red;"/>
					</div>
  ...
  <form:input path="ftitle" readonly="true" cssClass="form-control" value="${cmtfrmInfo.ftitle}" placeholder="Forum title....."/>
      ...
      <form:input cssClass="form-control" readonly="true" placeholder="Enter Content" value="${cmtfrmInfo.fcontent}" path="fcontent" />
      ...
      <div class="form-group">
			<div class="col-xs-5">
				<label for="category">Category:</label>
					<form:input path="category" readonly="true" placeholder="Topic Subject...." value="${cmtfrmInfo.category}" cssClass="form-control"/>
						</div>
						 <div class="col-sm-3">
